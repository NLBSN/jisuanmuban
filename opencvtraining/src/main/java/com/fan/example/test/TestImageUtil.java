package com.fan.example.test;

import com.fan.example.util.ImageUtil;
...
public class TestImageUtil {
    ...
    private static Mat imread = Imgcodecs.imread("./data/photo/00005.jpg");
